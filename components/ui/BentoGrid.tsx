...
export const BentoGridItem = ({
    ...
    const handleCopy = () => {
        navigator.clipboard.writeText('dn.nunezdylan@gmail.com')
        setCopied(true)
    }
        ...
        >
            ...
            <div className={`${id === 6 && 'flex justify-center'} h-full`}>
                ...
                <div className={cn(
                    ...
                    <div
                        className={`font-sans font-bold text-base lg:text-2xl max-w-96 z-10`}
                    >
                        {title}
                    </div>
                        ...
                        <div className="flex gap-1 lg:gap-5 w-fit absolute -right-0">
                            <div className="flex flex-col gap-3 lg:gap-4">
                                {['Javascript', 'React', 'Node.js'].map((item) => (
                                    <span key={item} className="py-2 lg:py4 lg:px-3 px-3 text-xs lg:text-sm opacity-50 lg:opacity-100 rounded-lg text-center bg-[#10132E]">
                                        {item}
                                    </span>
                                ))}
